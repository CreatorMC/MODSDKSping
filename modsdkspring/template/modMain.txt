...
class [MOD_NAME](object):
    ...
    def __init__(self):
        logger.info("===== init %s mod =====", modConfig.MOD_NAME)

    @Mod.InitServer()
    def [MOD_NAME]ServerInit(self):
        logger.info("===== init %s server =====", modConfig.SERVER_SYSTEM_NAME)
        serverApi.RegisterSystem(modConfig.MOD_NAME, modConfig.SERVER_SYSTEM_NAME, modConfig.SERVER_SYSTEM_CLS_PATH)
    ...
    def [MOD_NAME]ClientInit(self):
        ...
        clientApi.RegisterSystem(modConfig.MOD_NAME, modConfig.CLIENT_SYSTEM_NAME, modConfig.CLIENT_SYSTEM_CLS_PATH)
