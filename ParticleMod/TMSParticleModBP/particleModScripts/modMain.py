...
class TMSParticleMod(object):

    def __init__(self):
        logger.info("===== init %s mod =====", modConfig.MOD_NAMESPACE)

    @Mod.InitServer()
    def TMSParticleModServerInit(self):
    ...
    @Mod.DestroyServer()
    def TMSParticleModServerDestroy(self):
        logger.info("===== destroy %s server =====", modConfig.SERVER_SYSTEM_NAME)
    
    @Mod.InitClient()
    def TMSParticleModClientInit(self):
    ...
    @Mod.DestroyClient()
    def TMSParticleModClientDestroy(self):
